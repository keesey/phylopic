...
import type { ImageFile, S3ClientProvider } from "../interfaces"
...
export class SubmissionClient extends S3TaggingPatcher<Submission> implements ReturnType<SourceClient["submission"]> {
