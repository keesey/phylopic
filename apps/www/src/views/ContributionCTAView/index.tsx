                ...
                <div className={styles.columns}>
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            <abbr title="Application Programming Interface">API</abbr>. They may also add features to
                            the <SiteTitle /> website.
                        </p>
                        <ul className={styles.ctaList}>
                            <li>
                                <Link
                    ...
                    <section>
                        <h3>Donations</h3>
                        <p>
                            Keep <SiteTitle /> online by making a donation to the web service fund, or to one of the
                            many other projects <SiteTitle /> relies on.
                        </p>
                        <ul className={styles.ctaList}>
                            <li>
                                <a
